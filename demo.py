...
def_par=[100.0,150.0,10.0,'spead/sender/EOR+Foreground/sky_eor_model_f*.osm']
...
for start_f in start_freq:
    ...
    cmd.append('oskar_sim_interferometer --set demo.ini interferometer/ms_filename '+'demo_f'+str(start_f)+'.ms')
